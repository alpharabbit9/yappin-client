...
const SignUp = () => {
    ...
    return (
        <div className='w-full flex items-center justify-center p-4 bg-slate-900'>
            <div className='relative w-full max-w-6xl md:h-[600px] h-[520px]'>
                        ...
                        <div className='md:w-1/2  p-6 flex items-center justify-center md:border-r border-slate-600/30'>
                            ...
                            <div className='w-full max-w-md '>
                                ...
                                <div className='text-center mb-8'>
                                    ...
                                    <h2 className='text-2xl font-bold text-slate-400 mb-2'>Create New Account</h2>
                                ...
                                <form className='space-y-6'>
                                    ...
                                    <button onClick={handleSubmit} className='auth-btn' type='submit' disabled={isSigningUp}>
                                        {
                                            isSigningUp ? (
